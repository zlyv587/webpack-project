...
exports.default = function (_ref) {
  ...
  return {
    visitor: {
      Program: function Program(path, _ref6) {
        var opts = _ref6.opts;
  ...
  function createStaticChecks() {
    return {
      ...
      instanceof: function _instanceof(_ref7) {
        var path = _ref7.path;
        var annotation = _ref7.annotation;
  ...
  function checkStringLiteral(_ref11) {
  ...
  function checkNumericLiteral(_ref12) {
  ...
  function checkIntersection(_ref15) {
  ...
  function checkGenerator(_ref18) {
  ...
  function checkClass(_ref20) {
    var input = _ref20.input;
    var types = _ref20.types;
    var scope = _ref20.scope;

    return checkIsClass({ input: input });
  }

  function checkArray(_ref21) {
    var input = _ref21.input;
    var types = _ref21.types;
  ...
  function checkTuple(_ref22) {
    var input = _ref22.input;
    var types = _ref22.types;
  ...
  function checkObject(_ref23) {
    var input = _ref23.input;
    var properties = _ref23.properties;
    var indexers = _ref23.indexers;
    ...
    if (indexers.length) {
      return indexers.reduceRight(function (expr, indexer) {
  ...
  function checkObjectPattern(_ref24) {
    var input = _ref24.input;
    var properties = _ref24.properties;
    var scope = _ref24.scope;
  ...
  function getObjectPropertyAnnotation(path) {
    ...
    return t.objectTypeProperty(node.key, annotation);
  }
  ...
  function getLogicalExpressionAnnotation(path) {
    ...
    if (isBooleanExpression(node)) {
      ...
      switch (node.operator) {
        case '&&':
        case '||':
          var _ref25 = [getAnnotation(left), getAnnotation(right)];
          left = _ref25[0];
          right = _ref25[1];
