...
function demo(input) {
  function _ref(_id) {
    if (!(typeof _id === 'string' || typeof _id === 'number')) {
      throw new TypeError("Function \"demo\" return value violates contract, expected string | number got " + (_id === null ? 'null' : (typeof _id === "undefined" ? "undefined" : _typeof(_id)) === 'object' && _id.constructor ? _id.constructor.name || '[Unknown Object]' : typeof _id === "undefined" ? "undefined" : _typeof(_id)));
    }
