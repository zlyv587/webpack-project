...
function demo(input) {
  ...
  if (!(input instanceof Map && Array.from(input.values()).every(function (value) {
    ...
    throw new TypeError("Value of argument \"input\" violates contract, expected Map<*, number> got " + (input === null ? 'null' : (typeof input === "undefined" ? "undefined" : _typeof(input)) === 'object' && input.constructor ? input.constructor.name || '[Unknown Object]' : typeof input === "undefined" ? "undefined" : _typeof(input)));
  }
