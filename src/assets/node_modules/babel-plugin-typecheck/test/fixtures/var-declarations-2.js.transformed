  ...
  try {
    for (var _iterator = a[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
      ...
      if (c == '1') {
          ...
          if (!(typeof x === 'number')) {
            throw new TypeError('Value of variable "x" violates contract, expected number got ' + (x === null ? 'null' : (typeof x === 'undefined' ? 'undefined' : _typeof(x)) === 'object' && x.constructor ? x.constructor.name || '[Unknown Object]' : typeof x === 'undefined' ? 'undefined' : _typeof(x)));
          }
        }
    }
  } catch (err) {
